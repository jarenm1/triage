> Archived on 2026-09-12 from Git commit `839125f`. Read [the current plan](../../PLAN.md) for research priorities, selected work, and experiment protocols. The text below preserves the earlier engineering contracts and historical evidence; its roadmap and status statements describe that earlier plan.
